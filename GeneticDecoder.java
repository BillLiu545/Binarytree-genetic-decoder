...
public class GeneticDecoder extends Application
{
    public void start(Stage mainStage)
    {
        ...
        mainStage.setTitle("Genetic Binary Tree Decoder App");
        
        // Add a title header
        Label titleLabel = new Label("Genetic Decoder");
        titleLabel.setStyle("-fx-font-size: 25px; -fx-font-weight: bold;");
        titleLabel.setTextFill(Color.AQUA);
        ...
        Label geneLabel = new Label(gene.entireGene());
        ...
        addButton.setOnAction((event->
        {
            ...
            alert.showAndWait();
            geneLabel.setText(gene.entireGene());
        }));
        // Remove chemical
        ...
        MenuItem manMutateItem = new MenuItem("Mutate");
        manMutateItem.setOnAction((event->{
        ...
        randMutateItem.setOnAction((event->{
            String mutated = gene.random_mutate();
            Alert alert = new Alert(AlertType.INFORMATION);
            alert.setTitle("Message");
            alert.setHeaderText("Message");
            alert.setContentText(mutated);
        ...
        fileMenu.getItems().addAll(manMutateItem, randMutateItem, chemCompItem, closeItem);
